        ...
        <div className="min-h-screen bg-brand-bg pb-24 relative">
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <section className="mb-16">
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center font-display">
                        <span className="w-10 h-10 rounded-xl bg-pink-100 text-brand-primary flex items-center justify-center mr-3 text-xl shadow-sm">📞</span>
                        Emergency Helplines
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {helplines.map((line, idx) => (
                            <div key={idx} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                                <h3 className="font-bold text-lg text-slate-900 mb-2">{line.name}</h3>
                                <p className="text-sm text-slate-500 mb-4 h-10 leading-relaxed">{line.desc}</p>
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {apps.map((app, idx) => (
                            <div key={idx} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col">
                                ...
                                <p className="text-slate-600 text-sm mb-6 leading-relaxed flex-grow">{app.desc}</p>
                                <div className="mt-auto flex gap-3 items-center">
                                    <a href={app.ios} target="_blank" rel="noreferrer" className="flex-1 bg-slate-900 text-white text-xs font-medium py-2.5 px-3 rounded-xl text-center hover:bg-slate-800 transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2">
                                        <FaApple size={14} />
                                        App Store
                                    </a>
                                    <a href={app.android} target="_blank" rel="noreferrer" className="flex-1 bg-slate-900 text-white text-xs font-medium py-2.5 px-3 rounded-xl text-center hover:bg-slate-800 transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2">
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {officialLinks.map((link, idx) => (
                            <a key={idx} href={link.url} target="_blank" rel="noreferrer" className="group block bg-white p-5 rounded-xl shadow-sm border border-slate-100 hover:border-pink-200 hover:shadow-md transition-all">
                ...
                <section>
                    ...
                    <div className="bg-gradient-to-br from-pink-50 to-white rounded-2xl p-8 border border-pink-100 shadow-sm">
                        <div className="grid grid-cols-1 gap-8 items-start">

                            {/* Google Sheets Tracker */}
                            <div id="symptom-tracker" className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-10 h-10 rounded-xl bg-green-100 text-green-600 flex items-center justify-center text-xl">
                                        <FaTable />
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-bold text-slate-900">Symptom Tracker</h3>
                                        <p className="text-xs text-slate-500">Powered by Google Sheets</p>
                                    </div>
                                </div>
                            ...
                            {/* PDF Downloads */}
                            <div>
                                <h3 className="text-lg font-bold text-slate-900 mb-4 font-display">Offline Resources</h3>
                                <div className="flex flex-col gap-4">
                                    <a href="/complete-guide.pdf" download className="flex items-center justify-between px-5 py-4 bg-white border border-slate-200 rounded-xl hover:border-brand-primary hover:shadow-md transition-all group">
