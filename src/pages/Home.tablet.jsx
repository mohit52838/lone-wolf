...
const Home = () => {
    ...
    // Show latest 8 chapters for tablet
    ...
    return (
        <div className="home-page">
            ...
            <section ref={heroRef} className="hero-section">
                ...
                {/* Soft UI Elements - Scaled for Tablet */}
            ...
            <section className="highlights-section">
                ...
                <div className="features-grid">
                    ...
                    <Card title="Safe Community" className="feature-card">
                        <p>Join a supportive, judgment-free environment.</p>
        ...
        .grid-plane { position: absolute; bottom: -50%; left: -50%; width: 200%; height: 200%; background-image: linear-gradient(var(--tron-grid-color) 1px, transparent 1px), linear-gradient(90deg, var(--tron-grid-color) 1px, transparent 1px); background-size: 70px 70px; opacity: 0.4; mask-image: linear-gradient(to top, black 20%, transparent 80%); }
        ...
        .circle-1 { width: 500px; height: 500px; top: 50%; left: 50%; transform: translate(-50%, -50%); }
        .circle-2 { width: 350px; height: 350px; top: 50%; left: 50%; transform: translate(-50%, -50%); border-style: dashed; }

        .hero-content { position: relative; z-index: 5; text-align: center; max-width: 800px; padding: 0 30px; }
        .hero-title { 
        ...
        .hero-subtitle { font-size: 1.3rem; color: #64748b; margin: 0 auto 2.5rem; font-family: var(--font-body); max-width: 550px; }
        ...
        .btn-secondary { padding: 0.9rem 2.2rem; background: white; color: var(--text-color); border: 1px solid #e2e8f0; border-radius: 50px; font-weight: 700; text-decoration: none; transition: all 0.3s; display: inline-block; }
        .btn-secondary:hover { background: #f8fafc; border-color: var(--primary-pink); color: var(--primary-pink); }

        /* HIGHLIGHTS SECTION */
        .highlights-section { padding: 50px 5%; max-width: 1200px; margin: 0 auto; position: relative; z-index: 10; }
        .section-header { margin-bottom: 30px; text-align: center; }
        .section-title { font-size: 2.5rem; font-family: var(--font-header); color: var(--text-color); margin-bottom: 1rem; }
        .header-line { width: 80px; height: 4px; background: var(--primary-pink); margin: 0 auto; border-radius: 2px; }
        .features-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 25px; } /* 3 columns for tablet landscape, maybe 2 for portrait? Keeping 3 for now as tablet usually handles it */
        .feature-card { height: 100%; display: flex; flex-direction: column; justify-content: space-between; padding: 1.5rem; }
        .card-icon { font-size: 2.5rem; color: var(--accent-cyan); margin-top: 1.5rem; opacity: 0.2; align-self: flex-end; }

        @media (max-width: 900px) {
            .features-grid { grid-template-columns: repeat(2, 1fr); } /* 2 columns for smaller tablets */
            .feature-card:last-child { grid-column: span 2; } /* Center last card */
        }
        ...
        .chapters-header { padding: 0 5%; margin-bottom: 40px; z-index: 2; }
        ...
        .slide-icon { font-size: 2.2rem; color: var(--accent-purple); margin-bottom: 1.2rem; }
        ...
        /* CTA SECTION */
        .cta-section { padding: 120px 20px; text-align: center; background: radial-gradient(circle at center, rgba(255, 122, 162, 0.05), transparent 70%); }
      `}</style>
        </div>
    );
};
